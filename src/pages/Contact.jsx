            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-text text-sm leading-relaxed">[Add Company Address Here]</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-text text-sm leading-relaxed">[Add Phone Number]</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-text text-sm leading-relaxed">[Add Email Address]</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-text text-sm leading-relaxed">
                    Monday – Saturday: [Add Hours]<br/>
                    Sunday: [Add Hours / Closed]
                  </p>
                </div>
              </div>
            </div>
